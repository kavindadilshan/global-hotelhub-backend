...
public class QueryHotelConstant {
    ...
    public static final String GET_USER_REPORT = "select name,contactNumber,email,Count(s.users_id) as filtering_count from users LEFT JOIN searchhotelhistory  s ON (s.users_id = users.id) \n" +
